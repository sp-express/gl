...
final class Scan
{
    ...
    public const STATUS_PGP_REGISTERED_WRONG_SORTING = 'STATUS_PGP_WRONG_SORTING';
    public const STATUS_PGP_REGISTERED_MISSING_IN_TRANSPORT = 'STATUS_PGP_MISSING_IN_TRANSPORT';
